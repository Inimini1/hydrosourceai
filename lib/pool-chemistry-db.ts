...
export const CYA_CHLORINE_TABLE = [
  ...
  { cya_ppm: 10,  min_free_cl: 1.0, recommended_cl: 1.5, notes: 'Minimal protection — the absolute 1 ppm floor still applies below ~CYA 13; retest frequently outdoors' },
  { cya_ppm: 20,  min_free_cl: 1.5, recommended_cl: 2.5, notes: 'Low stabilizer — moderate sun protection' },
  { cya_ppm: 30,  min_free_cl: 2.25, recommended_cl: 3.0, notes: 'IDEAL — good balance of protection and chlorine efficacy' },
  { cya_ppm: 40,  min_free_cl: 3.0, recommended_cl: 4.0, notes: 'IDEAL — standard for most outdoor pools' },
  { cya_ppm: 50,  min_free_cl: 3.75, recommended_cl: 5.0, notes: 'Upper ideal — chlorine demand increases' },
...
export const CHEMICAL_PRODUCTS: ChemicalProduct[] = [
  ...
  },
  {
    ...
    dosing_formula: '20 fl oz per 10,000 gal lowers pH by ~0.2 units; also lowers TA by ~8 ppm',
  ...
  },
  {
    ...
    concentration: '99%',
    dosing_formula: '6 oz per 10,000 gal raises pH by ~0.2 units; also raises TA by ~5 ppm',
