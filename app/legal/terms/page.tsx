  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-2xl mx-auto px-5 py-16">
        ...
        {/* Safety disclaimer */}
        <div className="rounded-3xl p-5 mb-8" style={{ background: 'rgba(245,158,11,0.07)', border: '1px solid rgba(245,158,11,0.25)' }}>
        ...
        <div className="space-y-8 text-slate-600 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-slate-900 font-bold text-lg mb-3">2. AI Recommendations</h2>
          ...
          <section>
            <h2 className="text-slate-900 font-bold text-lg mb-3">3. Eligibility</h2>
          ...
          <section>
            <h2 className="text-slate-900 font-bold text-lg mb-3">4. Account Responsibilities</h2>
            <ul className="space-y-2">
              {[
          ...
          <section>
            <h2 className="text-slate-900 font-bold text-lg mb-3">5. Acceptable Use</h2>
          ...
          <section>
            <h2 className="text-slate-900 font-bold text-lg mb-3">6. Beta Program</h2>
          ...
          <section>
            <h2 className="text-slate-900 font-bold text-lg mb-3">7. Subscriptions & Billing</h2>
          ...
          <section>
            ...
            <p className="mb-3 text-slate-700 font-medium">To the fullest extent permitted by law, we are not liable for:</p>
            <ul className="space-y-2">
              {[
            ...
            <p className="mt-4 p-3 rounded-xl text-xs bg-slate-50 text-slate-500">Our total liability shall not exceed the amount you paid us in the 12 months prior to the claim, or $100 USD, whichever is greater.</p>
          </section>

          <section>
            <h2 className="text-slate-900 font-bold text-lg mb-3">9. Disclaimer of Warranties</h2>
          ...
          <section>
            <h2 className="text-slate-900 font-bold text-lg mb-3">10. Changes to Terms</h2>
