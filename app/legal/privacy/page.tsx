...
export const metadata: Metadata = {
  title: 'Privacy Policy — HydroSource AI',
  description: 'How HydroSource AI collects, uses, and protects your data, including test strip photos and water chemistry readings.',
}
      ...
      <div className="max-w-2xl mx-auto px-5 py-16">
        ...
        <div className="space-y-8 text-slate-600 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p>HydroSource AI is a pool management application. We help pool owners and professionals analyze water chemistry and track pool maintenance. Contact us at hydrosource.ai@appscloud365.com.</p>
          </section>
          ...
          <section>
            ...
            <div className="rounded-2xl p-4 mb-4" style={{ background: 'rgba(0,111,255,0.04)', border: '1px solid rgba(0,111,255,0.15)' }}>
              ...
              <p>HydroSource AI analyzes water chemistry data to provide general scientific suggestions based on standard pool chemistry principles (such as the Langelier Saturation Index). All recommendations are framed as suggestions, not authoritative instructions. Language such as &quot;based on your readings, we suggest…&quot; or &quot;a common approach is…&quot; is used intentionally. The AI will never state &quot;you must&quot; or &quot;you are required to&quot; with respect to any chemical action.</p>
            </div>

            <div className="space-y-3">
              {[
                { title: 'No regulatory or legal compliance opinions', body: 'HydroSource AI is not a licensed pool inspector, regulatory authority, or legal advisor. We do not cite, interpret, or apply any specific local, state, or federal regulations — including but not limited to TDLR rules, state health codes, OSHA standards, or HOA and commercial facility codes. Chemistry data you submit is used for service optimization only, not to render regulatory opinions.' },
                { title: 'Commercial and public pools', body: 'If your pool is a commercial or public facility (hotel, apartment complex, school, gym, HOA), HydroSource AI will include a prominent notice that commercial pools are subject to jurisdiction-specific health and safety regulations. You must verify all recommendations with your local authority or a licensed commercial pool operator before applying them. HydroSource AI assumes no responsibility for regulatory compliance decisions.' },
                { title: 'No health safety guarantees', body: 'HydroSource AI does not guarantee health or safety outcomes. We will not state that a pool "is safe to swim in" based solely on chemistry readings. Our language is deliberately limited to phrases such as "the readings are within a commonly accepted range" or "these levels suggest the water is approaching a balanced state." When a reading indicates a potential health or equipment risk, we flag it clearly and recommend consulting a certified pool professional or local health authority before allowing pool use.' },
                { title: 'Chemical dosing', body: 'Dosing amounts provided are based on standard water chemistry formulas and are presented as ranges for general reference. Actual dosing must be confirmed against your specific product label and pool conditions. HydroSource AI is not liable for outcomes resulting from the application of any suggested chemical treatment without appropriate professional verification.' },
                { title: 'Limitation of liability', body: 'This tool provides general guidance only. Pool conditions vary and professional judgment should always be applied. HydroSource AI is not a substitute for professional inspection, regulatory compliance, or licensed pool service. By using this application, you acknowledge that all decisions regarding pool treatment and swimmer safety remain solely your responsibility.' },
              ].map((item) => (
                <div key={item.title} className="rounded-2xl p-4 bg-white" style={{ border: '1px solid rgba(0,0,0,0.07)' }}>
                  <p className="text-slate-900 font-semibold mb-1">{item.title}</p>
                  <p>{item.body}</p>
