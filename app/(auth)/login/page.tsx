    ...
    <div className="w-full max-w-sm animate-in">
      ...
      <div className="card-glass p-7 rounded-3xl space-y-4">
        ...
        {message === 'check-email' && !error && (
          <div className="p-3.5 rounded-2xl bg-safe/10 border border-safe/20 text-safe text-sm font-medium flex items-start gap-2">
        ...
        <div className="space-y-2.5">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3 rounded-2xl border border-slate-200 text-slate-700 text-sm font-semibold
                       hover:bg-slate-50 hover:border-slate-300 transition-all duration-200 disabled:opacity-50 cursor-pointer bg-white"
          >
            {oauthLoading
