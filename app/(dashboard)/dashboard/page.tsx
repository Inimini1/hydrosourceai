...
function Skeleton() {
  return (
    <div className="pb-6">
      ...
      {/* Hero blob */}
      <div className="flex flex-col items-center py-8 px-4 min-h-[300px] justify-center gap-4">
        <div className="w-52 h-52 skeleton-dark" style={{ borderRadius: '40% 60% 70% 30% / 40% 50% 60% 50%' }} />
