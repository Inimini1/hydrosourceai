...
export default function TopBar() {
  ...
  const avatarColor = user?.avatarColor ?? '#533afd'
      ...
      <div className="max-w-2xl mx-auto px-4 h-16 flex items-center justify-between">
        <Link href="/dashboard" className="flex items-center gap-2.5 group">
          ...
          <span className="text-[10px] font-medium px-2 py-0.5 rounded-full tracking-wider"
            style={{ background: 'rgba(83,58,253,0.10)', color: '#533afd', border: '1px solid rgba(83,58,253,0.20)' }}>BETA</span>
        </Link>
        ...
        <div className="flex items-center gap-2.5">
          {user?.subscriptionStatus !== 'PRO' && (
            <Link
              ...
              style={{ background: 'rgba(83,58,253,0.08)', color: '#533afd', border: '1px solid rgba(83,58,253,0.20)' }}
            >
