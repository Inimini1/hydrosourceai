...
export default function ConsentBanner() {
  ...
  return (
    ...
    >
      ...
      >
        <svg className="w-4 h-4 shrink-0" style={{ color: '#00C9B1' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <p className="text-xs text-white/50 flex-1 leading-relaxed">
          ...
          <Link href="/legal/terms" className="underline underline-offset-2" style={{ color: '#00C9B1' }}>Terms</Link>
          {' & '}
          <Link href="/legal/privacy" className="underline underline-offset-2" style={{ color: '#00C9B1' }}>Privacy</Link>.
        </p>
        <div className="flex items-center gap-2 shrink-0">
          <button onClick={decline} className="text-xs text-white/35 hover:text-white/55 transition-colors px-2 py-1.5">
            Decline
          </button>
          <button onClick={accept} className="text-xs font-bold text-white px-4 py-1.5 hover:opacity-90 transition-opacity whitespace-nowrap"
            style={{ background: '#00C9B1', borderRadius: '4px' }}>
            Accept & Continue
          </button>
        </div>
      </div>
