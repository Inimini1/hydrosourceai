...
export default function ConsentBanner() {
  ...
  return (
    ...
    >
      ...
      >
        <svg className="w-4 h-4 shrink-0" style={{ color: '#7389ff' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <p className="text-xs text-white/50 flex-1 leading-relaxed">
          ...
          <Link href="/legal/terms" className="underline underline-offset-2" style={{ color: '#7389ff' }}>Terms</Link>
          {' & '}
          <Link href="/legal/privacy" className="underline underline-offset-2" style={{ color: '#7389ff' }}>Privacy</Link>.
        </p>
